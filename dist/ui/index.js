...
function Text({ variant = "body", as: Tag2 = "p", className = "", children, ...rest }) {
  const cls = ["lvis-text", `lvis-text-${variant}`, className].filter(Boolean).join(" ");
  return /* @__PURE__ */ jsx4(Tag2, { ...rest, className: cls, children });
}
...
function Stack({
  ...
  return /* @__PURE__ */ jsx10(Tag2, { ...rest, className: cls, children });
}
function Inline({
  gap = "sm",
  align,
        ...
        "div",
        {
          ...
          children: [
            shouldRenderHeader && /* @__PURE__ */ jsxs4("div", { className: "lvis-modal-head", children: [
              shouldRenderTitle && (titleIsString ? /* @__PURE__ */ jsx11("h2", { id: titleId, className: "lvis-modal-title", children: title }) : /* @__PURE__ */ jsx11("div", { className: "lvis-modal-title", children: title })),
