 ...
 */
export const MARKETPLACE_PUBLIC_KEYS = Object.freeze({
 ...
 */
export function getTrustedMarketplacePublicKeys(options) {
 ...
 */
export const MARKETPLACE_PRIMARY_KEY_ID = "poc-v1";
